...
- **Transactions** — income/expense/transfer ledger, recurring & installment generation, transfer fees, credit-card transfer reclassification, CSV receipt/statement import.
